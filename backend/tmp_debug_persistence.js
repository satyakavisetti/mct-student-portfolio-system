...
(async () => {
  try {
    ...
    const result = await query(
      'SELECT student_id, platform, username, total_active_days, active_days, current_streak, max_streak, topic_statistics FROM coding_profiles WHERE student_id = $1 AND platform = $2',
      [1, 'leetcode']
    );
    console.log('DB_ROW');
